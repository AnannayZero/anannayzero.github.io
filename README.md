...
<head>
    ...
    <title>Ibucatto Comparator v4.5 | UI Shell</title>
...
<div class="container">
    <div class="header">
        ...
        <div class="global-controls">
            <input type="text" id="currencySign" placeholder="Sign ($, €, etc)" class="small-input">
            <input type="password" id="apiKey" placeholder="Gemini API Key" class="small-input key-field">
            <div id="engine-status">ENGINE: 3.1-FLASH-LITE</div>
        </div>
    </div>

    <div class="use-case-box">
        <span class="label">Contextual Target (Specific Workload)</span>
        <input type="text" id="uCase" class="use-case-input" 
               placeholder="e.g. 4K Video Editing in AE, 3D Rendering in Blender, Heavy Gaming...">
    </div>

    <div class="arena">
        
        <div class="slot" id="slot1">
            <div class="loading-mask">INITIALIZING ENGINE...<br>UPLINKING DATA CORE</div>
            
            <div class="input-group">
                <input type="text" id="q1" class="model-input" placeholder="Laptop Model 1 Name">
            ...
            <div class="analysis">
                <span class="label">Best For (Use Case Strengths)</span>
                <ul id="sum1">
                    </ul>
            </div>
        </div>
        ...
        <div class="slot" id="slot2">
            ...
            <div class="input-group">
                <input type="text" id="q2" class="model-input" placeholder="Laptop Model 2 Name">
